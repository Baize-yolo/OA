<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="职位名称" prop="zhiweimingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="职称名称" prop="zhichengmingcheng">
          <el-select :disabled="ro.zhichengmingcheng" v-model="ruleForm.zhichengmingcheng" placeholder="请选择职称名称">
            <el-option
