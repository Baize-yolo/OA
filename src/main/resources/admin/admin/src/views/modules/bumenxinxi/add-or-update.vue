<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门地址" prop="bumendizhi">
          <el-input v-model="ruleForm.bumendizhi" 
              placeholder="部门地址" clearable  :readonly="ro.bumendizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门地址" prop="bumendizhi">
              <el-input v-model="ruleForm.bumendizhi" 
                placeholder="部门地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
