<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资名称" prop="gongzimingcheng">
          <el-input v-model="ruleForm.gongzimingcheng" 
              placeholder="工资名称" clearable  :readonly="ro.gongzimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资名称" prop="gongzimingcheng">
              <el-input v-model="ruleForm.gongzimingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人卡号" prop="gerenkahao">
          <el-input v-model="ruleForm.gerenkahao" 
              placeholder="个人卡号" clearable  :readonly="ro.gerenkahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人卡号" prop="gerenkahao">
              <el-input v-model="ruleForm.gerenkahao" 
                placeholder="个人卡号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开户行" prop="kaihuxing">
          <el-input v-model="ruleForm.kaihuxing" 
              placeholder="开户行" clearable  :readonly="ro.kaihuxing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开户行" prop="kaihuxing">
              <el-input v-model="ruleForm.kaihuxing" 
                placeholder="开户行" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加班补助" prop="jiabanbuzhu">
          <el-input v-model="ruleForm.jiabanbuzhu" 
              placeholder="加班补助" clearable  :readonly="ro.jiabanbuzhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加班补助" prop="jiabanbuzhu">
              <el-input v-model="ruleForm.jiabanbuzhu" 
                placeholder="加班补助" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="应扣金额" prop="yingkoujine">
          <el-input v-model="ruleForm.yingkoujine" 
              placeholder="应扣金额" clearable  :readonly="ro.yingkoujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="应扣金额" prop="yingkoujine">
              <el-input v-model="ruleForm.yingkoujine" 
                placeholder="应扣金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    shijigongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiabanbuzhu==""?0:this.ruleForm.jiabanbuzhu)-parseFloat(this.ruleForm.yingkoujine==""?0:this.ruleForm.yingkoujine) || 0
      }
    },
  },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinxibianhao = true;
          ...
          if(o=='gongzimingcheng'){
            this.ruleForm.gongzimingcheng = obj[o];
	    this.ro.gongzimingcheng = true;
            continue;
          }
          if(o=='gonghao'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='gerenkahao'){
            this.ruleForm.gerenkahao = obj[o];
	    this.ro.gerenkahao = true;
            continue;
          }
          if(o=='kaihuxing'){
            this.ruleForm.kaihuxing = obj[o];
	    this.ro.kaihuxing = true;
            continue;
          }
          if(o=='jibengongzi'){
	    ...
	    this.ro.jiabanbuzhu = true;
          ...
          if(o=='yingkoujine'){
            this.ruleForm.yingkoujine = obj[o];
	    this.ro.yingkoujine = true;
            continue;
          }
          if(o=='shijigongzi'){
