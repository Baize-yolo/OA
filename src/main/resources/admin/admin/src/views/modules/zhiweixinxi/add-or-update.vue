<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职位薪酬" prop="zhiweixinchou">
          <el-input v-model="ruleForm.zhiweixinchou" 
              placeholder="职位薪酬" clearable  :readonly="ro.zhiweixinchou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职位薪酬" prop="zhiweixinchou">
              <el-input v-model="ruleForm.zhiweixinchou" 
                placeholder="职位薪酬" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="职位职责" prop="zhiweizhize">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="职位职责"
                  v-model="ruleForm.zhiweizhize" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhiweizhize" label="职位职责" prop="zhiweizhize">
                    <span>{{ruleForm.zhiweizhize}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiweimingcheng = true;
          ...
          if(o=='zhiweixinchou'){
            this.ruleForm.zhiweixinchou = obj[o];
	    this.ro.zhiweixinchou = true;
            continue;
          }
          if(o=='zhiweizhize'){
            this.ruleForm.zhiweizhize = obj[o];
	    this.ro.zhiweizhize = true;
            continue;
          }
        }
      }
