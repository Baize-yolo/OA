    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiweimingcheng = true;
          ...
          if(o=='zhichengmingcheng'){
            this.ruleForm.zhichengmingcheng = obj[o];
	    this.ro.zhichengmingcheng = true;
            continue;
          }
          if(o=='gerenkahao'){
      ...
      this.$http({
		...
		if(json.bumenmingcheng!=''&&json.bumenmingcheng){
                this.ruleForm.bumenmingcheng = json.bumenmingcheng
	    		this.ro.bumenmingcheng = true;
		}
		if(json.zhiweimingcheng!=''&&json.zhiweimingcheng){
                this.ruleForm.zhiweimingcheng = json.zhiweimingcheng
	    		this.ro.zhiweimingcheng = true;
		}
		if(json.zhichengmingcheng!=''&&json.zhichengmingcheng){
                this.ruleForm.zhichengmingcheng = json.zhichengmingcheng
	    		this.ro.zhichengmingcheng = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongzizhanghao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongzizhanghaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
